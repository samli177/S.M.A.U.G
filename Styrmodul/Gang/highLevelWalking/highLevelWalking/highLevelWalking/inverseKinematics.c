...
{
	x0_1 = -(100 + (new_z - z0))/sqrt2-61.85; 
	y0_1 = (100 + (new_z - z0))/sqrt2+120;
}

void height_change_leg2(float new_z)
{
	x0_2 = -(100 + (new_z - z0))-100;
}

void height_change_leg3(float new_z)
{
	x0_3 = -(100 + (new_z - z0))/sqrt2-61.85;
	y0_3 = -(100 + (new_z - z0))/sqrt2-120; 
}

void height_change_leg4(float new_z)
{
	x0_4 = (100 + (new_z - z0))/sqrt2+61.85;
	y0_4 = -(100 + (new_z - z0))/sqrt2-120; 
}

void height_change_leg5(float new_z)
{
	x0_5 = (100 + (new_z - z0))+100;
}

void height_change_leg6(float new_z)
{
	x0_6 = (100 + (new_z - z0))/sqrt2+61.85;
	y0_6 = (100 + (new_z - z0))/sqrt2+120;
}
