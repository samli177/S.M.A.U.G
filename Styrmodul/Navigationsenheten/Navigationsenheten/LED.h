...
#define LED0_ON PORTA |= (1 << PORTA0)
#define LED0_OFF PORTA &= ~(1 << PORTA0)
#define LED0_TOGGLE PORTA ^= (1 << PORTA0)

#define LED1_ON PORTA |= (1 << PORTA1)
#define LED1_OFF PORTA &= ~(1 << PORTA1)
#define LED1_TOGGLE PORTA ^= (1 << PORTA1)
